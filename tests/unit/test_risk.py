...
BASES = {
    ...
    "communication.contact_trusted_contact finance.verify_request governance.pause_automation governance.resume_automation governance.record_constraint governance.withdraw_constraint",
