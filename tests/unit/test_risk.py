...
BASES = {
    ...
    "communication.contact_trusted_contact finance.verify_request governance.pause_automation governance.resume_automation governance.record_constraint governance.withdraw_constraint governance.record_plan governance.approve_plan governance.revise_plan governance.cancel_plan governance.record_observations governance.refresh_plan governance.memory",
