...
- [`ADR-006-twin-first-adapters.md`](./ADR-006-twin-first-adapters.md) — Every adapter ships real and twin behind one interface; the twin is product, not test scaffolding; credential-free energy feeds with explicit coverage and tariff provenance
