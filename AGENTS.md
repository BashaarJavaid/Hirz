...
**Phase 3 item 19a is locally verified; item 20 is next.** Durable local refresh/recovery now covers twin households and configured HA thermostats. Item 15's physical plug/absence checks remain pending. Evidence: `docs/verification-log.md`; procedures: `docs/development.md`. Development remains on `0005_execution_attempt`; migrations 0006–0008 are manual. MCP, companion delivery, live feed ingestion, AWS and remote CI remain outside this verification.
