...
- 2026-09-23: Add authenticated tool latency and concurrent household-isolation gates, with signed per-action batching and transaction-scoped snapshot reuse; full latency/CI verification remains pending ([ADR-017](./docs/adr/ADR-017-tool-latency-and-isolation.md), [evidence](./docs/verification-log.md#item-26--2026-09-23)).
